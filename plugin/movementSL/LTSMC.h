...
SMC_API short __stdcall smc_board_init(WORD ConnectNo,WORD type,const char *pconnectstring,DWORD dwBaudRate);
...
SMC_API short __stdcall smc_set_pulse_fractional_number(WORD ConnectNo,WORD axis,WORD fractional_number);
SMC_API short __stdcall smc_get_pulse_fractional_number(WORD ConnectNo,WORD axis,WORD* fractional_number);
...
SMC_API short __stdcall smc_sine_oscillate_get_mode(WORD ConnectNo,WORD Axis,WORD* mode);
SMC_API short __stdcall smc_sine_oscillate_set_amplitude_tacc(WORD ConnectNo,WORD Axis,double tacc_s);
...
SMC_API short __stdcall smc_sine_oscillate_set_cycle_num(WORD CardNo, WORD Axis, DWORD cycle_num);
SMC_API short __stdcall smc_sine_oscillate_get_cycle_num(WORD CardNo, WORD Axis, DWORD *cycle_num);
...
SMC_API short __stdcall smc_arc_move_angle_unit(WORD ConnectNo,WORD Crd,WORD AxisNum,WORD* AxisList,double *Cen_Pos,double Angle, double *Target_Pos, WORD posi_mode);
...
//固定PWM高电平时间设置
SMC_API short __stdcall smc_set_pwm_fix_high_width(WORD ConnectNo,WORD pwm_no, WORD enable, double high_width_s);
SMC_API short __stdcall smc_get_pwm_fix_high_width(WORD ConnectNo,WORD pwm_no, WORD * enable, double * high_width_s);
...
//当同时开启硬件INP和软件INP时最后INP状态是必须两种INP信号均到位才认为到位
//硬件输入INP配置
...
SMC_API short __stdcall smc_get_ain_extern(WORD ConnectNo,WORD channel,double* Vout);
...
//TRACE数据采集新规划
SMC_API short __stdcall smc_trace_set_config(WORD ConnectNo, short trace_cycle, short lost_handle, short trace_type, short trigger_object_index, short trigger_type, int mask, int64 condition);
SMC_API short __stdcall smc_trace_get_config(WORD ConnectNo,short * trace_cycle, short * lost_handle, short * trace_type, short * trigger_object_index, short * trigger_type, int * mask, int64 * condition);
SMC_API short __stdcall smc_trace_reset_config_object(WORD ConnectNo);
SMC_API short __stdcall smc_trace_add_config_object(WORD ConnectNo, short data_type, int data_index, int data_sub_index, short slave_id, short data_bytes);
SMC_API short __stdcall smc_trace_get_config_object(WORD ConnectNo,short object_index, short * data_type, int * data_index, int * data_sub_index, short * slave_id, short * data_bytes);
...
SMC_API short __stdcall smc_userlib_imd_stop(WORD ConnectNo,WORD axis);
...
SMC_API short __stdcall smc_get_axis_follow_trajectory_displacement(WORD ConnectNo, WORD crd, WORD*num, WORD* Axis_list);
SMC_API short __stdcall smc_set_tool_length_compensation_param(WORD ConnectNo, WORD axis, double length);
SMC_API short __stdcall smc_get_tool_length_compensation_param(WORD ConnectNo, WORD axis, double* length);
SMC_API short __stdcall smc_set_tool_length_compensation_enable(WORD ConnectNo, WORD axis, WORD enable);
SMC_API short __stdcall smc_get_tool_length_compensation_enable(WORD ConnectNo, WORD axis, WORD* enable);
SMC_API short __stdcall smc_set_normal_direction_control(WORD ConnectNo, WORD crd, WORD axis, WORD mode);
SMC_API short __stdcall smc_get_normal_direction_control(WORD ConnectNo, WORD crd, WORD* axis, WORD* mode);
SMC_API short __stdcall smc_set_gap_cmp_param(WORD ConnectNo, WORD crd, WORD pin, WORD logic, WORD mode, WORD auxi_axis, WORD source, long  rev_time, double* gap);
SMC_API short __stdcall smc_get_gap_cmp_param(WORD ConnectNo, WORD crd, WORD* pin, WORD* logic, WORD* mode, WORD* auxi_axis, WORD* source, long* rev_time, double* gap);
SMC_API short __stdcall smc_set_gap_cmp_enable(WORD ConnectNo, WORD crd, WORD enable);
SMC_API short __stdcall smc_get_gap_cmp_enable(WORD ConnectNo, WORD crd, WORD* enable);
SMC_API short __stdcall smc_set_normal_direction_control_enable(WORD ConnectNo, WORD crd, WORD enable);
...
SMC_API short __stdcall smc_get_watchdog_enable_extern(WORD ConnectNo, WORD index, double * timer_period, WORD* enable);
SMC_API short __stdcall smc_reset_watchdog_timer_extern(WORD ConnectNo, WORD index);

SMC_API short __stdcall smc_conti_force_set_position(WORD ConnectNo, WORD Crd, WORD axis_num, WORD* axis_list, double* position); 

SMC_API short __stdcall smc_set_modulo_profile(WORD ConnectNo, WORD axis,WORD enable,double Modulo_Vel);
SMC_API short __stdcall smc_get_modulo_profile(WORD ConnectNo, WORD axis,WORD *enable,double *Modulo_Vel);
...
SMC_API short __stdcall smc_set_acuate_angle_config_params(WORD ConnectNo, WORD Crd, double acuate_angle, double angle_trans_speed, WORD enable);
SMC_API short __stdcall smc_get_acuate_angle_config_params(WORD ConnectNo, WORD Crd, double* acuate_angle, double* angle_trans_speed, WORD* enable);

SMC_API short __stdcall smc_conti_dxXYZLineBuff(WORD ConnectNo, WORD Crd, char* buff, WORD pack_num);
SMC_API short __stdcall smc_conti_dfXYZLineBuff(WORD ConnectNo, WORD Crd, char* buff, WORD pack_num);
SMC_API short __stdcall smc_delete_file(WORD ConnectNo, WORD FileType);

SMC_API short __stdcall nmcs_ecat_read_slave_register(WORD ConnectNo, WORD wSlaveAddress, WORD wRegisterOffset, WORD wLen, char* pdwData);
SMC_API short __stdcall nmcs_ecat_write_slave_register(WORD ConnectNo, WORD wSlaveAddress, WORD wRegisterOffset, WORD wLen, char* pdwData);
SMC_API short __stdcall smc_cir_count_start(WORD ConnectNo,WORD Channel);

SMC_API short __stdcall smc_get_cir_count_flag(WORD ConnectNo, WORD Channel,WORD * Flag);

SMC_API short __stdcall smc_cir_count_reset(WORD ConnectNo, WORD Channel);

SMC_API short __stdcall smc_get_cir_count_value(WORD ConnectNo,WORD Channel,WORD *Value);
SMC_API short __stdcall smc_set_io_exactstop_ex(WORD ConnectNo,WORD axis, WORD ioNum,WORD *ioList,WORD *ioTypeList,WORD *ioLogicList,WORD enable,WORD action,WORD move_dir);
SMC_API short __stdcall nmcs_set_axis_run_mode(WORD ConnectNo, WORD axis,WORD run_mode);


SMC_API short __stdcall smc_wafer_meas_compare_config(WORD ConnectNo,WORD axis,WORD enable, WORD source);
SMC_API short __stdcall smc_wafer_meas_clear_point(WORD ConnectNo);
SMC_API short __stdcall smc_wafer_meas_add_point(WORD ConnectNo,double start_pos,double interval,WORD count);
SMC_API short __stdcall smc_wafer_meas_get_value(WORD ConnectNo,double* pos,WORD* val);


///////////////20240717新增，单轴运动缓存功能

SMC_API short __stdcall smc_m_open_list(WORD ConnectNo, WORD group, WORD axis_num, WORD* axis_list);
SMC_API short __stdcall smc_m_start_list(WORD ConnectNo, WORD group);
SMC_API short __stdcall smc_m_close_list(WORD ConnectNo, WORD group);
SMC_API short __stdcall smc_m_get_run_state(WORD ConnectNo, WORD group, WORD* state, WORD* enable, DWORD* stop_reason, WORD* trig_phase, DWORD* mark);
SMC_API short __stdcall smc_m_stop_list(WORD ConnectNo, WORD group,WORD stopMode);
SMC_API short __stdcall smc_m_pause_list(WORD ConnectNo, WORD group,WORD stop_mode);
SMC_API short __stdcall smc_m_add_time_delay(WORD ConnectNo, WORD group, double Time_delay, DWORD mark);
SMC_API short __stdcall smc_m_add_sigaxis_moveseg_data_ex(WORD ConnectNo, WORD group, WORD Axis, double Target_pos, DWORD mark);
SMC_API short __stdcall smc_m_add_wait_event_data(WORD ConnectNo, WORD group, WORD event, WORD num, WORD CompareOperator, double target_value, DWORD mark);
SMC_API short __stdcall smc_m_add_trigger_data(WORD ConnectNo, WORD group, WORD mode, WORD num, double Target_Value, DWORD mark);
SMC_API short __stdcall smc_m_set_profile_unit(WORD ConnectNo, WORD group, WORD axis, double start_vel, double max_vel, double tacc, double tdec, double stop_vel);
SMC_API short __stdcall nmcs_sync_pos_change_mode (WORD ConnectNo, WORD portno, WORD axis);

//批量传输
SMC_API short __stdcall smc_conti_pack_on(WORD ConnectNo);
SMC_API short __stdcall smc_conti_pack_off(WORD ConnectNo);
SMC_API short __stdcall smc_conti_pack_flush(WORD ConnectNo);

SMC_API short __stdcall nmcs_get_master_state(WORD ConnectNo, uint32*States);
SMC_API short __stdcall smc_set_gap_cmp_space(WORD ConnectNo, WORD crd, double space);
SMC_API short __stdcall smc_get_gap_cmp_space(WORD ConnectNo, WORD crd, double* space);
SMC_API short __stdcall nmcs_set_stop_io_map_virtual(WORD ConnectNo, WORD VirtualBitNo, WORD MapIoType, WORD MapIoIndex, WORD MapIoLogic, WORD MapIoFilter);
SMC_API short __stdcall nmcs_get_stop_io_map_virtual(WORD ConnectNo, WORD VirtualBitNo, WORD* MapIoType, WORD* MapIoIndex, WORD* MapIoLogic, WORD *MapIoFilter);

SMC_API short __stdcall nmcs_set_stop_extra_pdo_map_virtual(WORD ConnectNo, WORD VirtualExtraPdo, WORD MapExtraPdoType, WORD MapExtraPdoAddress, WORD MapDataLen, uint32 MapMaxData, uint32 MapMinData);
SMC_API short __stdcall nmcs_get_stop_extra_pdo_map_virtual(WORD ConnectNo, WORD VirtualExtraPdo, WORD* MapExtraPdoType, WORD* MapExtraPdoAddress, WORD* MapDataLen, uint32* MapMaxData, uint32 *MapMinData);
SMC_API short __stdcall nmcs_set_extra_stop_mode(WORD ConnectNo, WORD Axis, WORD VirtualIoNum, WORD* VirtualIoList, WORD VirtualExtraPdoNum, WORD* VirtualExtraPdoList, WORD CmpMode, WORD StopMode);
...
//二维螺距补偿
SMC_API short __stdcall smc_set_leadscrew_comp_2D_config_unit(WORD ConnectNo, WORD axis, WORD* ref_axis,double* ref_axis_start_pos, double* ref_axis_length, WORD* ref_axis_segment, double* CompPos);
SMC_API short __stdcall smc_get_leadscrew_comp_2D_config_unit(WORD ConnectNo, WORD axis, WORD* ref_axis,double* ref_axis_start_pos, double* ref_axis_length, WORD* ref_axis_segment, double* CompPos);
SMC_API short __stdcall smc_set_leadscrew_comp_2D_angle_unit(WORD ConnectNo, WORD axis, WORD* ref_axis,double* ref_axis_start_pos, double* ref_axis_length, double angle);
SMC_API short __stdcall smc_get_leadscrew_comp_2D_angle_unit (WORD ConnectNo, WORD axis, WORD* ref_axis,double* ref_axis_start_pos, double* ref_axis_length, double *angle);
SMC_API short __stdcall smc_set_leadscrew_comp_2D_enable(WORD ConnectNo, WORD axis,WORD mode,WORD enable);
SMC_API short __stdcall smc_get_leadscrew_comp_2D_enable(WORD ConnectNo, WORD axis, WORD *mode, WORD *enable);

SMC_API short __stdcall smc_set_leadscrew_comp_2D_config_unit_ex(WORD ConnectNo, WORD table_index, WORD axis, WORD* ref_axis, double* ref_axis_start_pos, double* ref_axis_length, WORD* ref_axis_segment, double* value);
SMC_API short __stdcall smc_get_leadscrew_comp_2D_config_unit_ex(WORD ConnectNo, WORD table_index, WORD* axis, WORD* ref_axis, double* ref_axis_start_pos, double* ref_axis_length, WORD* ref_axis_segment, double* value);
SMC_API short __stdcall smc_set_leadscrew_comp_2D_angle_unit_ex(WORD ConnectNo, WORD table_index, WORD comp_axis, WORD* ref_axis, double* ref_axis_start_pos, double* ref_axis_length, double angle);
SMC_API short __stdcall smc_get_leadscrew_comp_2D_angle_unit_ex(WORD ConnectNo, WORD table_index, WORD* axis, WORD* ref_axis, double* ref_axis_start_pos, double* ref_axis_length, double *angle);
SMC_API short __stdcall smc_set_leadscrew_comp_2D_enable_ex(WORD ConnectNo, WORD table_index, WORD mode, WORD enable);
SMC_API short __stdcall smc_get_leadscrew_comp_2D_enable_ex(WORD ConnectNo, WORD table_index, WORD* mode, WORD* enable);

//螺距补偿
SMC_API short __stdcall smc_enable_leadscrew_comp(WORD ConnectNo, WORD axis,WORD enable);
SMC_API short __stdcall smc_set_leadscrew_comp_config_unit(WORD ConnectNo,WORD axis,WORD n,double startpos,double lenpos,double *pCompPos,double *pCompNeg);
SMC_API short __stdcall smc_get_leadscrew_comp_config_unit(WORD ConnectNo,WORD axis,WORD* n,double* startpos,double* lenpos,double *pCompPos,double *pCompNeg);
SMC_API short __stdcall smc_get_position_ex_unit(WORD ConnectNo, WORD axis, double *pos);//读取补偿后的位置

//龙门功能
SMC_API short __stdcall smc_set_gear_follow_profile(WORD CardNo,WORD axis,WORD enable,WORD master_axis,double ratIO);
SMC_API short __stdcall smc_get_gear_follow_profile(WORD CardNo,WORD axis,WORD* enable,WORD* master_axis,double* ratIO);
SMC_API short __stdcall smc_set_grant_error_protect_unit(WORD CardNo, WORD axis,WORD enable,double dstp_error, double EMG_error);
SMC_API short __stdcall smc_get_grant_error_protect_unit(WORD CardNo, WORD axis,WORD* enable,double* dstp_error, double* EMG_error);

//软启动/软着陆
SMC_API short __stdcall smc_t_pmove_extern_unit (WORD CardNo, WORD axis, double MidPos, double TargetPos, double Min_Vel, double Max_Vel, double stop_Vel, double acc, double dec, WORD posi_mode);
SMC_API short __stdcall smc_t_pmove_extern_softstart_unit (WORD CardNo, WORD axis, double MidPos, double TargetPos, double start_Vel, double Max_Vel, double stop_Vel, DWORD delay_ms, double Max_vel2,double stop_vel2, double acc_time, double dec_time, WORD posi_mode);
SMC_API short __stdcall smc_update_target_position_extern_unit(WORD cardId,WORD axis, double mid_pos, double aim_pos,double vel,WORD posi_mode);

//椭圆插补
SMC_API short __stdcall smc_ellipse_move(WORD ConnectNo,WORD Crd, WORD AxisNum, WORD *AxisList,double* TargetPos,double* CenPos,double ALen,double BLen, WORD Dir, WORD PosMode);
...
SMC_API short __stdcall nmcs_set_home_profile(WORD ConnectNo,WORD PortNum,WORD axis,WORD home_mode,double High_Vel,double Low_Vel,double Tacc,double Tdec,double offsetpos);

SMC_API short __stdcall nmcs_get_total_slaves(WORD ConnectNo,WORD PortNum,WORD* TotalSlaves);

SMC_API short __stdcall nmcs_write_outbit(WORD ConnectNo,WORD NoteID,WORD IoBit,WORD IoValue);
SMC_API short __stdcall nmcs_read_outbit(WORD ConnectNo,WORD NoteID,WORD IoBit,WORD *IoValue);
SMC_API short __stdcall nmcs_read_outbit(WORD ConnectNo,WORD NoteID,WORD IoBit,WORD *IoValue);
SMC_API short __stdcall nmcs_write_outport(WORD ConnectNo,WORD NodeID,WORD PortNo,WORD IoValue);
SMC_API short __stdcall nmcs_read_outport(WORD ConnectNo,WORD NodeID,WORD PortNo,DWORD *IoValue);
SMC_API short __stdcall nmcs_read_inport(WORD ConnectNo,WORD NodeID,WORD PortNo,DWORD *IoValue);

SMC_API short __stdcall smc_check_done_ex(WORD ConnectNo,WORD axis,WORD * state);//读取指定轴的运动状态
