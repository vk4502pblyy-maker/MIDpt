...
/* OpenSensorXXX
	...
	MEDAQLIB_API ERR_CODE WINAPI OpenSensorIF2008_ETH  (DWORD instanceHandle, LPCSTR remoteAddr, int channelNumber);
	...
	MEDAQLIB_API ERR_CODE WINAPI OpenSensorIF2008_ETHU (DWORD instanceHandle, LPCWSTR remoteAddr, int channelNumber);
